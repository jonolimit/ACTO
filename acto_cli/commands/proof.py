...
def verify(
    ...
    print("  Visit: https://https://acto-production.up.railway.app/dashboard")
    print("  Use the API Playground to verify proofs")
    print()
    print("[cyan]Get your API key at:[/cyan] https://https://acto-production.up.railway.app/dashboard")
